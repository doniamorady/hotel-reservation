...
return [
    ...
    */
    ...
    "password"         => [
        ...
        'mixed' => 'رمز عبور باید شامل حداقل یک حرف بزرگ و یک حرف کوچک باشد.',
        'numbers' => 'رمز عبور باید شامل حداقل یک عدد باشد.',
        'symbols' => 'رمز عبور باید شامل حداقل یک کاراکتر خاص باشد.',
        'uncompromised' => 'این رمز عبور در داده‌های لو رفته ظاهر شده است، لطفاً رمز دیگری انتخاب کنید.',
