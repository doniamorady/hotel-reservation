...
new class extends Component {
    ...
    {
        return [
            'bookings' => Booking::query()->when($this->search, function($q){
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span @class([ 'badge' , 'badge-light-warning'=> $booking->status === 'check_out',
                                'badge-light-success' => $booking->status === 'check_in',
                                'badge-light-danger' =>
                                $booking->status === 'cancelled' || $booking->status === 'expired',
                                'badge-light-primary' => !in_array($booking->status, [
                                'check_in',
                                'check_out',
                                ]),
                                ])>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <form action="{{ route('admin.bookings.change-status', $booking) }}" method="POST">
                                        ...
                                        <button type="submit" class="menu-link px-3" style="border: none">تغییر
                                            وضعیت</button>
