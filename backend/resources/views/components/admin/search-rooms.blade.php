        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_محصولات_table">
            ...
            <tbody class="fw-bold text-gray-600">
                ...
                @foreach ($rooms as $room)
                    <tr
                        style="
                            background-color: {{ $room->status ? '' : '#434343' }};
                            color: {{ $room->status ? 'inherit' : '#cfcfcf' }};
                            transition: .3s ease;">
                        <td>
                            {{ $loop->iteration }}-
                        </td>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-5">
                                    ...
                                    <a href="{{ route('admin.room.edit', $room) }}"
                                        ...
                                        style="
                                    text-decoration: {{ $room->status ? 'none' : 'line-through' }};
                                    ">
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    ...
                                    <button wire:click='changeStatus({{ $room }})'
                                        class="menu-link px-3 border-0 bg-transparent"
