            ...
            <div class="toast-body p-0">
                <div class="d-flex align-items-center bg-light-warning rounded p-5">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                        <span class="fw-bolder text-gray-800 mb-1">عملیات به روز رسانی</span>
                        {{-- نمایش پیام به‌روزرسانی از سشن --}}
                        <span class="fw-semibold text-gray-600 fs-7">{{ session('toast-update') }}</span>
                    </div>
